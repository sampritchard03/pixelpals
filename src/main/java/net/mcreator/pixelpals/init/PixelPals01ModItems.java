...
import net.mcreator.pixelpals.item.PeacefulPlainsItem;
...
public class PixelPals01ModItems {
	...
	public static final DeferredItem<Item> PEACEFUL_PLAINS = register("peaceful_plains", PeacefulPlainsItem::new);
	public static final DeferredItem<Item> PIXEL_GRASS = block(PixelPals01ModBlocks.PIXEL_GRASS);
	public static final DeferredItem<Item> PIXEL_DIRT = block(PixelPals01ModBlocks.PIXEL_DIRT);
	public static final DeferredItem<Item> PIXEL_STONE = block(PixelPals01ModBlocks.PIXEL_STONE);
	public static final DeferredItem<Item> PIXEL_SAND = block(PixelPals01ModBlocks.PIXEL_SAND);
	public static final DeferredItem<Item> BLOBBY_LOG = block(PixelPals01ModBlocks.BLOBBY_LOG);
	public static final DeferredItem<Item> BLOBBY_TREE = block(PixelPals01ModBlocks.BLOBBY_TREE);
	public static final DeferredItem<Item> TALL_GRASS = block(PixelPals01ModBlocks.TALL_GRASS);
	...
	public static final DeferredItem<Item> FALLEN_LEAVES = block(PixelPals01ModBlocks.FALLEN_LEAVES);
	public static final DeferredItem<Item> YELLOW_TREE = block(PixelPals01ModBlocks.YELLOW_TREE);
	public static final DeferredItem<Item> ORANGE_TREE = block(PixelPals01ModBlocks.ORANGE_TREE);
	...
	public static final DeferredItem<Item> TOAD_HOUSE_WALL = block(PixelPals01ModBlocks.TOAD_HOUSE_WALL);
	public static final DeferredItem<Item> SHROOM_CEMENT = block(PixelPals01ModBlocks.SHROOM_CEMENT);
	public static final DeferredItem<Item> BROWN_SHROOM_BRICKS = block(PixelPals01ModBlocks.BROWN_SHROOM_BRICKS);
	public static final DeferredItem<Item> WHITE_SHROOM_BRICKS = block(PixelPals01ModBlocks.WHITE_SHROOM_BRICKS);
	public static final DeferredItem<Item> TOAD_HOUSE_DOORWAY = block(PixelPals01ModBlocks.TOAD_HOUSE_DOORWAY);
	public static final DeferredItem<Item> RED_SHROOM_BLOCK = block(PixelPals01ModBlocks.RED_SHROOM_BLOCK);
	public static final DeferredItem<Item> RED_TOAD_HOUSE = block(PixelPals01ModBlocks.RED_TOAD_HOUSE);
	...
	public static final DeferredItem<Item> TOAD_HOUSE_DOOR = block(PixelPals01ModBlocks.TOAD_HOUSE_DOOR);
	public static final DeferredItem<Item> TOAD_HOUSE_DOOR_OPEN = block(PixelPals01ModBlocks.TOAD_HOUSE_DOOR_OPEN);
